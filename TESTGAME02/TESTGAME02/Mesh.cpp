	...
	float* pfNearHitDistance)
{
	...
	if (bIntersected)
	{
		...
		{
			XMVECTOR v0 = XMLoadFloat3((XMFLOAT3*)(pbPositions + (((i * nOffset) + 0)) * m_nStride));
			XMVECTOR v1 = XMLoadFloat3((XMFLOAT3*)(pbPositions + (((i * nOffset) + 1)) * m_nStride));
			XMVECTOR v2 = XMLoadFloat3((XMFLOAT3*)(pbPositions + (((i * nOffset) + 2)) * m_nStride));
			float fHitDistance;
